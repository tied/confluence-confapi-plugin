...
import de.aservo.atlassian.confluence.confapi.bean.PopMailServerBean;
import de.aservo.atlassian.confluence.confapi.bean.SmtpMailServerBean;
import de.aservo.atlassian.confluence.confapi.bean.error.ErrorCollection;
...
public class MailServerResourceTest {
    ...
    public void testPutPopMaiLServerCreate() throws Exception {
        ...
        assertEquals(PopMailServerBean.from(createPopMailServer), PopMailServerBean.from(popMailServer));
        assertEquals(requestPopMailServerBean, responsePopMailServerBean);
    }
